...
/* ★ 추출하기(primary) 버튼 : 최신 DOM = stBaseButton-primary */
...
/* ★ 복사용 키워드 박스 : 옆으로만 늘어남(줄바꿈 없음, 가로 스크롤) */
.copy-box {
...
/* ★ 결과 키워드(secondary) 버튼 : 최신 DOM = stBaseButton-secondary */
...
/* ★ 담긴 상태 : kw-picked 마커를 가진 가로블록의 버튼 배경 채움 (세로 안 늘어남) */
